  ...
  return (
    <View style = {styles.container}>
      ...
      <View style = {styles.div}>
        <Text style = {styles.text}>Rejestracja - krok 6</Text>
      </View>
      <View style = {styles.panel}>
        <Text style = {styles.rejText}>Wybierz sposób zawarcia umowy</Text>
      </View>
      <View style = {styles.panel2}>
        <Text style = {styles.rejText}>lub</Text>
      </View>
      <TouchableOpacity onPress = {buttonDalej} style = {styles.div2}>
        <Text style = {styles.text2}>W oddziale</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress = {buttonSelfie} style = {styles.div3}>
        <Text style = {styles.text2}>Przez selfie</Text>
      </TouchableOpacity>
    </View>
  );
};
